...
public class StringInteger {
    public static void main(String[] args) {
        ...
        String twonumbers="100,600";
        int numm1=Integer.parseInt(twonumbers.split(",")[0]);
        int numm2=Integer.parseInt(twonumbers.split(",")[1]);
        int sum=num1+num2;
        System.out.println("sum = " + sum);



        String [] arraynums=twonumbers.split(",");
        String firstnum=arraynums[0];
        String secondnum=arraynums[1];
        int numone=Integer.parseInt(firstnum);
        int numsecond=Integer.parseInt(secondnum);
       int summ=numone+numsecond;
