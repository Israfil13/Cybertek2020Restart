...
public class CarInventory {
    public static void main(String[] args) {
        String [] cars={
                ...
                "Chrysler-Town & Country",
                "Chevrolet-Colorado"};
//       String carsstr=Arrays.toString(cars);
//        System.out.println(Arrays.toString(cars));
       int countche=0;
        int countcivic=0;
//        for (int i = 0; i <cars.length ; i++) {
//           if (cars[i].startsWith("Chevrolet")){
//               ++countche;
...
//                System.out.println(cars[j]);
          ...
          System.out.println("countche = " + countche);
...
//        System.out.println("Car make is " + eachCarsplit[0] + " "+"Car moddel is "+eachCarsplit[1]);

//        for (String eachcar:cars){
//            if (eachcar.startsWith("Honda")){
//                String[] eachHonda=eachcar.split("-");
//                System.out.println("Car make is " + eachHonda[0] + " "+"Car moddel is "+eachHonda[1]);
//
//            }
//        }

        int twochar=0;
        for (String eachmodel:cars){
            String []eachCarsplit=eachmodel.split("-",2);
           String carmodel=eachCarsplit[1];
        ...
        int toyota=0;
        for (String toyotaeach : cars){
           if (toyotaeach.toLowerCase().contains("toyota")){
               ++toyota;
           }}
           ...
           for (String toyotaeach:cars){
                if (toyotaeach.toLowerCase().contains("toyota")){
                    toyotaarr+=toyotaeach+", ";
                }
            }
                String[] toyotaInventory={toyotaarr};
