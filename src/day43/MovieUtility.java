...
//        System.out.println("Total Hours = " + totalHours);
    ...
    public static void printMovieInformation(Movie movieObj) {
        //TODO YOUR CODE HERE
        System.out.println("The movie "+movieObj.getName()+" is "+movieObj.getLenght()+" hour long"
        +" and it genre is "+ movieObj.getGenre());
       ...
       String movie="";
        for (int i = 0; i <movieObj.getName().length(); i++) {
            if (i!=movieObj.getName().length()-1){
                movie+=movieObj.getName().charAt(i)+"-";
            }else {
                movie+=movieObj.getName().charAt(i);
            }
    ...
    public static void printShorterMovieName(Movie movieObj1, Movie movieObj2) {
        ...
        if (movieObj1.getLenght()>movieObj2.getLenght()){
            System.out.println(movieObj2.getName()+" is "+movieObj2.getLenght());
        }else{
            System.out.println(movieObj1.getName()+" is "+movieObj1.getLenght());
    ...
    public static String getCombinedMovieInfo(Movie movieObj) {
        ...
        //TODO YOUR CODE HERE
        combinedResult=movieObj.getName()+"-"+movieObj.getLenght()+"-"+movieObj.getGenre();
    ...
    public static Movie createFamilyMovie(String name, double len) {
        //TODO YOUR CODE HERE
//        Movie mfamily=new Movie(name,len);
