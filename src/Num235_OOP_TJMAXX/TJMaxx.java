...
public class TJMaxx extends OnSaleItem{
    ...
    public TJMaxx() {
//     super();
        List<Item> regularItems=new ArrayList<Item>();
        List<OnSaleItem> onSaleItems=new ArrayList<OnSaleItem>();
        //TODO
    ...
    public List<String> getAllItemNames() {
        ...
        for (int i = 0; i <regularItems.size() ; i++) {
            allItemNames.add(regularItems.get(i).getName());
        }
