...
public class MapIntro {
    public static void main(String[] args) {
        ...
        Map<Integer,String> groupnumgrouplead= new HashMap<>();

        Map<String,Double> groceryprice=new HashMap<>();

        Map<Byte,Character> correctanswer=new HashMap<>();

        Map<String ,Integer> namegae=new HashMap<>();
