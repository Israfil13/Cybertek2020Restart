...
//   TASK2     for (int i = 0; i <restaurants.length ; i++){
//            System.out.println((i+1)+"."+restaurants[i]);
//        }
//
        for (int i = 0; i < restaurants.length; i++) {
            if (restaurants[i].toLowerCase().contains("mcdonald's")) {
                mcdonalsCount++;
            }

        }
        System.out.println(mcdonalsCount);
//        Popeye's Chicken, Domino's Pizza, Taco Bell

//
//  TASK 4          for (int i = 0; i <restaurants.length; i++) {
...
//   TASK5     int num=0;
//            for (String eachelement:restaurants){
//                if (eachelement.contains("McDonald's")){
//                    if (eachelement.contains("TX")){
//                        ++num;
//                        System.out.println(num+"."+eachelement);
//                    }
//                }
//            }

//TASK6
//        String[] resarray=restaurants[0].split(",");
//        System.out.println(resarray[2]+"->"+resarray[1]+","+resarray[4]);
//
//TASK7
//        String []   allres;
//        for (int i = 0; i <restaurants.length ; i++) {
//            allres=restaurants[i].split(",");
//            System.out.println(allres[2]+"->"+allres[1]+","+allres[4]);
//        }
